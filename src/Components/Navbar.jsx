...
const Navbar = () => {
  return (
    <div className="nav">
      <div className="fixed z-[999] w-full px-6 sm:px-10 md:px-20 py-4 sm:py-5 flex items-center justify-between backdrop-blur-sm bg-white/10">
        {/* Logo Section */}
        <div className="logo">
          <svg
            width="72"
        ...
        {/* Links Section */}
        <div className="links hidden md:flex gap-10 cursor-pointer">
          {["Services", "Our Work", "About Us", "Insights", "Contact"].map(
            (item, index) => (
              <a
                key={index}
                className={`text-md font-semibold capitalize font-regular ${
                  index === 4 && "ml-52"
                }`}
              >
                {item}
